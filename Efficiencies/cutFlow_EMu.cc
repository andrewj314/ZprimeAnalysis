...
const string path     = "/uscms_data/d3/andrewj/CMSSW_7_4_7/src/Efficiencies/Zprime_M_2000/";
...
const double cand1_acc[2]       = {10, 2.4};
const double cand2_acc[2]       = {13, 2.5};
...
const int numTotCut       = 14; //dr+cand1_numTotCut+cand2_numTotCut+pair_numTotCut 
...
void cutFlow_EMu() {
 ...
 TFile* f = Call_TFile();
 cout << "File called\n";
 TTree* tree; f->GetObject("TNT/BOOM;10",tree);
...
void cutflow_eff(TTree* tree, int nentries){ 
 ...
 vector<double> *Muon_pt , *Muon_eta, *Muon_phi, *Muon_dz_pv, *Muon_energy;
 ...
 vector<double> *Muon_dB, *Muon_besttrack_pt, *Muon_besttrack_ptError, *Muon_besttrack_dxy, *Muon_besttrack_dz, *Muon_tunePBestTrack_pt;
 ...
 vector<double> *patElectron_gsfTrack_dxy_bs, *patElectron_isoChargedHadrons, *patElectron_isoNeutralHadrons, *patElectron_isoPhotons, *patElectron_isoPU;
 ...
 vector<int>    *patElectron_isPassVeto, *patElectron_isPassLoose, *patElectron_isPassMedium, *patElectron_isPassTight, *patElectron_isPassHEEPId, *patElectron_passConversionVeto, *patElectron_expectedMissingInnerHits;
 ...
 vector <int>   *Tau_decayModeFinding, *Tau_decayModeFindingNewDMs;
 ...
 TBranch *b_Muon_besttrack_dxy = 0; 
 TBranch *b_Muon_besttrack_dz = 0; 
 ...
 TBranch *b_patElectron_isoChargedHadrons = 0;
 TBranch *b_patElectron_isoNeutralHadrons = 0;
 TBranch *b_patElectron_isoPhotons = 0;
 TBranch *b_patElectron_isoPU = 0;
 ...
 TBranch *b_patElectron_isPassVeto = 0;
 TBranch *b_patElectron_isPassLoose = 0;
 TBranch *b_patElectron_isPassMedium = 0;
 TBranch *b_patElectron_isPassTight = 0;
 TBranch *b_patElectron_isPassHEEPId = 0;
 TBranch *b_patElectron_passConversionVeto = 0;
 TBranch *b_patElectron_expectedMissingInnerHits = 0;
 ...
 tree->SetBranchAddress("Muon_besttrack_dxy",&Muon_besttrack_dxy,&b_Muon_besttrack_dxy); 
 tree->SetBranchAddress("Muon_besttrack_dz",&Muon_besttrack_dz,&b_Muon_besttrack_dz); 
 ...
 tree->SetBranchAddress("patElectron_isoChargedHadrons",&patElectron_isoChargedHadrons,&b_patElectron_isoChargedHadrons);
 tree->SetBranchAddress("patElectron_isoNeutralHadrons",&patElectron_isoNeutralHadrons,&b_patElectron_isoNeutralHadrons);
 tree->SetBranchAddress("patElectron_isoPhotons",&patElectron_isoPhotons,&b_patElectron_isoPhotons);
 tree->SetBranchAddress("patElectron_isoPU",&patElectron_isoPU,&b_patElectron_isoPU);
 ...
 tree->SetBranchAddress("patElectron_isPassVeto",&patElectron_isPassVeto,&b_patElectron_isPassVeto);
 tree->SetBranchAddress("patElectron_isPassLoose",&patElectron_isPassLoose,&b_patElectron_isPassLoose);
 tree->SetBranchAddress("patElectron_isPassMedium",&patElectron_isPassMedium,&b_patElectron_isPassMedium);
 tree->SetBranchAddress("patElectron_isPassTight",&patElectron_isPassTight,&b_patElectron_isPassTight);
 tree->SetBranchAddress("patElectron_isPassHEEPId",&patElectron_isPassHEEPId,&b_patElectron_isPassHEEPId);
 tree->SetBranchAddress("patElectron_passConversionVeto",&patElectron_passConversionVeto,&b_patElectron_passConversionVeto);
 tree->SetBranchAddress("patElectron_expectedMissingInnerHits",&patElectron_expectedMissingInnerHits,&b_patElectron_expectedMissingInnerHits);
 ...
 for(int i=0; i<nentries; i++){
  ...
  b_patElectron_gsfTrack_dxy_pv->GetEntry(tentry);
  b_patElectron_gsfTrack_dz_pv->GetEntry(tentry);
  b_patElectron_isPassTight->GetEntry(tentry);
  b_patElectron_expectedMissingInnerHits->GetEntry(tentry);
  b_patElectron_passConversionVeto->GetEntry(tentry);
  b_patElectron_isoChargedHadrons->GetEntry(tentry);
  b_patElectron_isoNeutralHadrons->GetEntry(tentry);
  b_patElectron_isoPhotons->GetEntry(tentry);
  b_patElectron_isoPU->GetEntry(tentry); 
      ...
      if(Muon_eta->at(0) < cand1_acc[1]){
        ...
        if(patElectron_pt->at(0) >= cand2_acc[0]){
          ...
          if(patElectron_eta->at(0) < cand2_acc[1]){
            ...
            if(Muon_dxy_pv->at(0) < 0.045 && Muon_dz_pv->at(0) < 0.2){
              cut_eff[5] += wgt_pu;
              if(Muon_medium->at(0) > 0){
                cut_eff[6] += wgt_pu;
                if(fabs(patElectron_gsfTrack_dxy_pv->at(0)) < 0.045 && fabs(patElectron_gsfTrack_dz_pv->at(0)) < 0.2){
                  cut_eff[7] += wgt_pu;
                  if(patElectron_isPassTight->at(0) > 0){
                    cut_eff[8] += wgt_pu;
                    if(patElectron_expectedMissingInnerHits->at(0) <= 1){
                      cut_eff[9] += wgt_pu;
                      if(patElectron_passConversionVeto->at(0) > 0){
                        cut_eff[10] += wgt_pu;
                        TLorentzVector muon4Momentum;
			TLorentzVector electron4Momentum;
			muon4Momentum.SetPtEtaPhiE(Muon_pt->at(0), Muon_eta->at(0), Muon_phi->at(0), Muon_energy->at(0));
			electron4Momentum.SetPtEtaPhiE(patElectron_pt->at(0), patElectron_eta->at(0), patElectron_phi->at(0), patElectron_energy->at(0));
			double DeltaR = deltaR(Muon_eta->at(0), Muon_phi->at(0), patElectron_eta->at(0), patElectron_phi->at(0));
			cout << "DeltaR = " << DeltaR << "\n";
			if(DeltaR > 0.3){
			  cut_eff[11] += wgt_pu;
			  double Muon_Iso;
			  ...
			  cout << "Muon_Iso = " << Muon_Iso << "\n";
			  if(Muon_Iso < 0.15){
			    cut_eff[12] += wgt_pu;
			    double Electron_Iso;
			    cout << "patElectron_isoChargedHadrons->at(0)" << patElectron_isoChargedHadrons->at(0) << "\n";
			    cout << "patElectron_isoNeutralHadrons->at(0)" << patElectron_isoNeutralHadrons->at(0) << "\n";
			    cout << "patElectron_isoPhotons->at(0)" << patElectron_isoPhotons->at(0) << "\n";
			    cout << "patElectron_isoPU->at(0)" << patElectron_isoPU->at(0) << "\n";
			    if(patElectron_isoChargedHadrons->size() > 0 && patElectron_isoNeutralHadrons->size() > 0 && patElectron_isoPhotons->size() > 0 && patElectron_isoPU->size() > 0){
   			      cout << "Nonzero electron isos\n";
			      Electron_Iso = (patElectron_isoChargedHadrons->at(0) + max(patElectron_isoNeutralHadrons->at(0) + patElectron_isoPhotons->at(0) - 0.5*patElectron_isoPU->at(0), 0.0))/patElectron_pt->at(0);
			      cout << "Electron_Iso = " << Electron_Iso << "\n";
			    }
			    else Electron_Iso = 0.0;
			    cout << "Electron_Iso = " << Electron_Iso << "\n";
			    if(Electron_Iso < 0.15){
			      cut_eff[13] += wgt_pu;
			    }
			  }
			}
...
/////
void initialize_strings(vector<string> &varname, vector<string> &varcut){
  varname[0] = "e-mu pair exists:\t";
  varname[1] = "Muon Pt:\t\t"; varname[2] = "Muon eta:\t\t";
  varname[3] = "Electron Et:\t\t"; varname[4] = "Electron SC eta:\t";
  varname[5] = "Muon track dxy & dz:\t"; varname[6] = "Muon ID:\t\t";
  varname[7] = "Electron track dxy & dz:"; varname[8] = "Electron ID:\t\t";
  varname[9] = "Electron Missing Hits:\t"; varname[10] = "Electron Conversion Veto:";
  varname[11] = "EMu DeltaR:\t\t"; varname[12] = "Muon Iso:\t\t";
  varname[13] = "Electron Iso:\t\t";
