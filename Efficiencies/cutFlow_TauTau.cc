...
const int numTotCut       = 16; //dr+cand1_numTotCut+cand2_numTotCut+pair_numTotCut 
...
/////
void initialize_strings(vector<string> &varname, vector<string> &varcut){
  varname[0] = "Tau pair exists:\t";
  varname[1] = "Tau1 Pt:\t\t"; varname[2] = "Tau1 eta:\t\t";
  varname[3] = "Tau2 Pt:\t\t"; varname[4] = "Tau2 eta:\t\t";
  varname[5] = "Tau1 DMF new DMs:\t"; varname[6] = "Tau1 dz:\t\t";
  varname[7] = "Tau2 DMF new DMs:\t"; varname[8] = "Tau2 dz:\t\t";
  varname[9] = "Tau1Tau2 DeltaR:\t"; varname[10] = "Tau1 anti-e MVA5\t";
  varname[11] = "Tau1 anti-mu loose:\t"; varname[12] = "Tau2 anti-e MVA5:\t";
  varname[13] = "Tau2 anti-mu loose:\t"; varname[14] = "Tau1 Iso DB 3hits:\t";
  varname[15] = "Tau2 Iso DB 3hits:\t";
